...
DEFAULT_PKG_EXTENSION = ".pkg.br"
DEFAULT_PACKAGE_ASSEMBLY_EXTENSION = ".pkgs.br"
DEFAULT_FOLDER_INDEX_EXTENSION = ".idx.br"
DEFAULT_FOLDER_INDEX_NAME = f"this{DEFAULT_FOLDER_INDEX_EXTENSION}"

BRING_DEFAULT_MAX_PARALLEL_TASKS = 8
